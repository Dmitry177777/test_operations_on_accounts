...
class TestUtils(unittest.TestCase):
  ...
  def test_load(self):
    file_path_json = "../tests/data.json"

    value = [{'id': 441945886, 'state': 'EXECUTED', 'date': '2019-08-26T10:50:58.294041', 'operationAmount': {'amount': '31957.58', 'currency': {'name': 'руб.', 'code': 'RUB'}}, 'description': 'Перевод организации', 'from': 'Maestro 1596837868705199', 'to': 'Счет 64686473678894779589'},
       ...
       {'id': 214024827, 'state': 'EXECUTED', 'date': '2018-12-20T16:43:26.929246', 'operationAmount': {'amount': '70946.18', 'currency': {'name': 'USD', 'code': 'USD'}}, 'description': 'Перевод организации', 'from': 'Счет 10848359769870775355', 'to': 'Счет 21969751544412966366'},
    ...
    self.assertEqual(utils.load_data(file_path_json), value)
  ...
  def test_init_operation(self):
    ...
    value = ['26.08.2019 Перевод организации\nMaestro xxxxxxxx68705199 -> Счет xxxxxxxx678894779589\n31957.58 руб.\n\n ',
          '03.07.2019 Перевод организации\nMasterCard xxxxxxxx34726758 -> Счет xxxxxxxx474447895560\n8221.37 USD\n\n ',
          '04.04.2019 Перевод со счета на счет\nСчет xxxxxxxx243227258542 -> Счет xxxxxxxx383060284188\n79114.93 USD\n\n ',
          '23.03.2019 Перевод со счета на счет\nСчет xxxxxxxx784861134719 -> Счет xxxxxxxx417521191160\n43318.34 руб.\n\n ',
          '20.12.2018 Перевод организации\nСчет xxxxxxxx769870775355 -> Счет xxxxxxxx544412966366\n70946.18 USD\n\n ']

    self.assertEqual(utils.init_operation(data),value)
